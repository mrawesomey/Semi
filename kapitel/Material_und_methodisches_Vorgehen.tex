...
\section{Indirekte Immunfluoreszenz}
...
\begin{figure}[h] % [h] versucht, das Bild hier zu platzieren (hier), [t] für oben, [b] für unten
	...
	\caption{ Prinzip der indirekten Immunfluoreszenz \parencite{LeicaMicrosystems2026}} % Die Bildunterschrift
...
Wellenlänge angeregt. Nach der Anregung emittieren sie Licht mit einer längeren Wellenlänge. Dies ist darauf zurückzuführen, dass ein Teil der aufgenommenen Energie in Form von Schwingung oder Wärme an die Umgebung abgegeben wird. Dadurch steht für die Lichtemission weniger Energie zur Verfügung, wodurch das emittierte Licht eine geringere Wellenlänge als das Anregungslicht aufweist. Eine zentrale Komponente der WF-Mikroskopie ist der dichroitische Spiegel (oder
...
\begin{figure}[h] % [h] versucht, das Bild hier zu platzieren (hier), [t] für oben, [b] für unten
	...
	\caption{ Widefield Fluorescence Microsopy \parencite{ibidiWFMBild}} % Die Bildunterschrift
...
\begin{figure}[h] % [h] versucht, das Bild hier zu platzieren (hier), [t] für oben, [b] für unten
	...
	\caption{ Structured Illumination Microscopy \parencite{OxInstSIMBild}} % Die Bildunterschrift
...
2D-SIM werden dafür typischerweise neun Einzelaufnahmen aufgenommen.
...
fluoreszenzmarkierten Proteine, weshalb sie sich grundsätzlich zur Untersuchung der Proben eignet. Jedoch kommt es bei sehr kleinen oder dicht beieinander liegenden Strukturen dazu, dass sich ihre Fluoreszenzsignale nicht eindeutig voneinander unterscheiden lassen, da die Ränder verschwommen erscheinen können. Dies ist bei der Untersuchung der Kolokalisation zu beachten, da eine scheinbare Überlagerung von Signalen nicht
...
schneller Aufnahmegeschwindigkeit über die Zellproben. Bei beiden Methoden ist jedoch zu beachten, dass in dreidimensionalen Strukturen auch Zellteile tieferer Ebenen fluoreszieren können. \footcite{oxinstSIM}
