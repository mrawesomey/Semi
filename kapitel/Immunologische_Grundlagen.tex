...
\begin{figure}[h] % [h] versucht, das Bild hier zu platzieren (hier), [t] für oben, [b] für unten
	...
	\includegraphics[width=0.91\textwidth]{abbildungen/IGGPI.png} % Lädt das Bild, skaliert es auf 80% der Textbreite
	\caption{Verschiedene Unterformen der Immunglobuline-G-(IgG)-Antikörper \parencite{IGGbild_4u}} % Die Bildunterschrift
